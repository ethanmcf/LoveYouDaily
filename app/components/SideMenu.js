...
import { Text, Animated, Alert, View, TouchableOpacity, StyleSheet} from 'react-native';
                ...
                },
                {
                    ...
                    onPress: () => [
                        dbManager.removeCurrentCreatorAccount().then((error) => {
                            Alert.alert(error == null ? "Good bye!" : "Error", error == null ? "Sorry to see you leaving!" : "There was an error deleting your account, please try again later.")
                        }),
                        setIsSigned(false),
    ...
    return (
        <Animated.View style = {styles.container}>
            <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={styles.button} onPress={()=> [setIsSigned(false), dbManager.logOutCurrentUser()]}>
